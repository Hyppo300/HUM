...
export function NewsFeed({
  ...
  const showEmptyState =
    !isLoading && articles !== undefined && articles.length === 0;
  ...
  return (
    <div className="flex flex-col h-full" style={{ marginLeft: "10px" }}>
      ...
      {pagination && pagination.totalPages > 1 && (
        <div className="flex flex-col md:flex-row justify-between items-center mt-6 py-4 border-t gap-4">
          <div className="text-sm text-muted-foreground">
            ...
            <span className="ml-2">
              ({pagination.totalCount} articles total)
            </span>
          </div>
